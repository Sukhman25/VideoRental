...
{//'MainForm' is a class.  The only methods etc that should be here are those that apply to the form and it's components. 
    ...
    { //Instantiate database class - create a new 'instance' of it from the 'blueprint'
        ...
        //private vs public:  If there is no need for anyone else to have access to the method then it should be private. 
        //Anything that applies only to the class in which it is located can be a private.  
        //Anything that is going to be accessed by other classes needs to be public.  
        //Technically, the above method could be private
